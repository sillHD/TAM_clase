...
celulares = [] 
class celular():
    # funcion constructora o metodo constructor, establece los atributos
    ...
    # un metodo es una funcion dentro de una clase pero debe darsele el parametro self
    def encendido(self):
        print(f"el celular {self.marca} se esta encendiendo\n")
        
    #con el self se puede autoreferenciar
    def apagado(self):
